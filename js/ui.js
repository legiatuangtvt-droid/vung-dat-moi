...
function updateUI(){
  ...
  if(Object.keys(loadedModels).length>0){
    const cd=document.createElement('div');cd.innerHTML='<div class="cat-l">\u{1f4e6} Model GLB</div>';
    Object.keys(loadedModels).forEach(name=>{
      ...
      btn.innerHTML='<span class="bi">\u{1f4e6}</span><span><div class="bn">'+name+'</div><div class="bc">Model t\u00f9y ch\u1ec9nh</div></span>';
  ...
  h+='<div class="sr"><span class="sl">C\u00f4ng tr\u00ecnh</span><span class="sv">'+G.buildings.length+'</span></div><div class="sr"><span class="sl">D\u00e2n NPC</span><span class="sv">'+npcs.length+'</span></div><div class="sr"><span class="sl">Models GLB</span><span class="sv">'+Object.keys(loadedModels).length+'</span></div></div>';
